...
export const CONFIRM_DEFAULTS = {
  ...
  zoom: "We'll talk in my usual Zoom room, so this is the link you'll want when the time comes:",
  reschedule:
    "If something shifts on your end, you can pick a different time straight from {student}'s page and it'll update on my side automatically. There's no need to email me about it.",
