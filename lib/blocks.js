...
// The serial is a ZONELESS calendar day, so it must be read back in UTC: reading
// it as America/Los_Angeles lands on 17:00 the PREVIOUS day and formats to the
// wrong date (a 2026-08-13 block rendered as 2026-08-12). Matches the mirror
// scripts' SERIAL_EPOCH.plus({days}) math exactly.
