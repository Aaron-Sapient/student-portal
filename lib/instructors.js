...
export const INSTRUCTORS = {
  ryan: {
    ...
    /* How this person is named to a FAMILY, as against `displayName` ("Ryan"),
       which is how they are named inside the product. Added 2026-09-05 for the
       lead confirmation email (lib/nextLeadEmail.js): "Your conversation with
       Ryan is confirmed" is how a colleague writes, and this is the first
       written thing a family receives from the firm. Server-side only, so no
