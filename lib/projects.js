...
// EXPORTED so app/api/submitUpdateForm reuses it instead of keeping its own copy —
// that copy used native Date and rendered these same columns a day early on any
// server behind UTC. One parser per responsibility.
export function toLADate(raw) {
